...
librarian::shelf(naturecounts, tidyverse, sf, "r-spatial/rgee", googleCloudStorageR, geojsonio,
                 future)
...
# Fix ee_extract following solution <https://github.com/r-spatial/rgee/issues/367>
